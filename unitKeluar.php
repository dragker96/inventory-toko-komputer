...
<div class="mt-3 m-3">
<h4 class="mt-2">Kelola Unit Keluar</h4>
  <a class="btn btn-outline-info" href="UKtambah.php"><i class="oi oi-plus"></i> Tambah Data</a>
  <br>
	<br>
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tr>
			...
			<td><?php echo $data['id_unit']; ?>
  			...
  			<td>
				<a class="btn btn-sm btn-info" href="UKedit.php?no_nota=<?php echo $data['no_nota']; ?>"><i class="oi oi-pencil"></i> Edit</a> 
				<a class="btn btn-sm btn-danger" href="cek_UKhapus.php?no_nota=<?php echo $data['no_nota']; ?>"><i class="oi oi-trash"></i> Hapus</a>					
			</td>
		</tr>
		<?php } ?>
	</table>
