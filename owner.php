...
<nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navigasi_kecil">
		...
		<ul class="navbar-nav mr-auto text-body text-dark">
			<li class="nav-item"><a class="nav-link" href="Odashboard.php"><span class="oi oi-dashboard text-black-50"></span> Home</a></li>
			<li class="nav-item"><a class="nav-link" href="OhomeUM.php"><span class="oi oi-clipboard text-black-50"></span> Unit Masuk</a></li>
			<li class="nav-item"><a class="nav-link" href="Ounit(2).php"><span class="oi oi-document text-black-50"></span> Unit</a></li> 
			<li class="nav-item"><a class="nav-link" href="OunitKeluar.php"><span class="oi oi-external-link text-black-50"></span> Unit Keluar</a></li> 
            <li class="nav-item"><a class="nav-link" href="stok.php"><span class="oi oi-spreadsheet text-black-50"></span> Stok Tersedia</a></li> 
            <li class="nav-item"><a class="nav-link" href="laporan.php"><span class="oi oi-file text-black-50"></span> Laporan Penjualan</a></li> 
